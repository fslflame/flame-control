...
import { useElementBounding, useWindowSize, useWindowScroll, useMutationObserver, } from "@vueuse/core";
import { ellipsisApiInjectionKey } from "./context";
import { defineComponent, ref, reactive, onMounted, onUnmounted, toValue, watch, provide, computed, } from "vue";
export default defineComponent((props, { slots }) => {
    ...
    const { stop: stopMutation } = useMutationObserver(triggerInnerRef, initEllipsis, {
        attributes: true,
        characterData: true,
        subtree: true,
    });
