...
export default defineComponent((_, { slots }) => {
    ...
    return () => (<div onMouseenter={mouseEnter} onMouseleave={mouseLeave} ref={el} style={tootipRef}>
      <div style={tootipStyle}>
        <div>{slots.default?.()}</div>
        <C.TriangleBox variants={{
            position: data?.position,
        }}>
          <C.TriangleChild variants={{
            position: data?.position,
